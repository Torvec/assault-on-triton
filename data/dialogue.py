...
SCRIPTED = {
    ...
    "level_boss_intro_1_2": {
        "speaker": CAST["enemy_commander"]["name"],
        "portrait": CAST["enemy_commander"]["portrait"],
        "text": "Test Text 2",
        "duration": 2.0,
        "location": CAST["enemy_commander"]["location"],
    },
    "level_boss_intro_1_3": {
        "speaker": CAST["hero"]["name"],
        "portrait": CAST["hero"]["portrait"],
        "text": "Test Text 3",
        "duration": 2.0,
